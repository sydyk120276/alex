...
Route::get('/frontnews', 'App\Http\Controllers\NewsController@index')->name('frontnews');
Route::get('/frontnews/{slug}', 'App\Http\Controllers\NewsController@show')->name('frontnews.single');
