                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-header">
                            <h3 class="card-title">Новый проект</h3>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="platform1">Выбрать файл(android)</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="platform2">Выбрать файл(apple)</label>
                                </div>
                            </div>
                        </div>
