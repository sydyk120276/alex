...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Редактирование Head-news</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card-header">
                            <h3 class="card-title">{{ $head->title }}</h3>
                ...
                <form role="form" method="post" action="{{ route('heads.update', ['head' => $head->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="keywords" class="form-control @error('keywords') is-invalid @enderror"
                                id="keywords" value="{{ $head->keywords }}">
                        </div>
