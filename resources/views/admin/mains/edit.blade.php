...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Редактирование основной страницы</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card-header">
                            <h3 class="card-title">Редактирование основной страницы</h3>
                ...
                <form role="form" method="post" action="{{ route('mains.update', ['main' => $main->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title_item" class="form-control @error('title_item') is-invalid @enderror"
                                id="title_item" value="{{ $main->title_item }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description_button" type="text" id="description_button" rows="3" class="form-control @error('description_button') is-invalid @enderror"
                                >{{ $main->description_button }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-25"><img class="img-thumbnail w-100" src="{{ $main->getImage() }}" alt=""></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="thumbnail2">Выбрать другой файл</label>
                                </div>
                            </div>
                            <div class="w-25"><img class="img-thumbnail w-100" src="{{ $main->getThumbnail2() }}" alt=""></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="thumbnail3">Выбрать другой файл</label>
                                </div>
                            </div>
                            <div class="w-25"><img class="img-thumbnail w-100" src="{{ $main->getThumbnail3() }}" alt=""></div>
                        </div>
