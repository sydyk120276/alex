...
<body class="hold-transition sidebar-mini">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview">
                      ...
                      <li class="nav-item has-treeview">
                        <a href="{{ route('developments.index') }}" class="nav-link">
                            <i class="nav-icon fas fa-archive"></i>
                            <p>
                                Разработки
                                <i class="right fas fa-angle-left"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('developments.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Список разработок</p>
                                </a>
                            </li>
                        </ul>
                        {{-- <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('developments.create') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Новая разработка</p>
                                </a>
                            </li>
                        </ul> --}}
                    </li>
    ...
    <script>
        ...
        .create( document.querySelector( '#content' ), {
            ...
            toolbar: [ 'ckfinder', 'imageUpload', 'mediaEmbed', '|', 'heading', '|', 'bold', 'italic', '|', 'undo', 'redo' ]
        } )
