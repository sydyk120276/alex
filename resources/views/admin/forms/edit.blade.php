    ...
    <section class="content">
        ...
        <div class="card">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card-header">
                            <h3 class="card-title">Форма проекта</h3>
                ...
                <form role="form" method="post" action="{{ route('forms.update', ['form' => $form->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title_item" class="form-control @error('title_item') is-invalid @enderror"
                                id="title_item" value="{{ $form->title_item }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description_button" type="text" id="description_button" rows="3" class="form-control @error('description_button') is-invalid @enderror"
                                placeholder="Описание ...">{{ $form->description_button }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="w-25"><img class="img-thumbnail w-100" src="{{ $form->getImage() }}" alt=""></div>
                        </div>
