    ...
    <section class="content">
        ...
        <div class="card">
            <div class="container-fluid">
                ...
                <form role="form" method="post" action="{{ route('forms.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
