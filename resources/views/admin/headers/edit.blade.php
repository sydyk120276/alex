    ...
    <section class="content">
        ...
        <div class="card">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card-header">
                            <h3 class="card-title">Редактирование шапки</h3>
                ...
                <form role="form" method="post" action="{{ route('headers.update', ['header' => $header->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title_logo" class="form-control @error('title_logo') is-invalid @enderror"
                                id="title_logo" value="{{ $header->title_logo }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-25"><img class="img-thumbnail w-100" src="{{ $header->getModeButton() }}" alt=""></div>
                        </div>
