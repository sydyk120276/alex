                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-header">
                            <h3 class="card-title">Новый сервис</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title_item" class="form-control @error('title_item') is-invalid @enderror"
                                id="title_item" placeholder="Название сервиса">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="platform1">Выбрать файл</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="platform2">Выбрать файл</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="platform2">Платформа03</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="platform3" id="platform3">
                                    <label class="custom-file-label" for="platform3">Выбрать файл</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="platform2">Платформа04</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="platform4" id="platform4">
                                    <label class="custom-file-label" for="platform4">Выбрать файл</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="platform2">Платформа05</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="platform5" id="platform5">
                                    <label class="custom-file-label" for="platform5">Выбрать файл</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="platform2">Платформа06</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="platform6" id="platform6">
                                    <label class="custom-file-label" for="platform6">Выбрать файл</label>
                                </div>
                            </div>
                        </div>
